Execute the steps from the `.spec.md` file using Playwright MCP tools in headed mode and use DOM inspection to locate elements and run each step in order.
...
Always run MCP with `headed: true`.
